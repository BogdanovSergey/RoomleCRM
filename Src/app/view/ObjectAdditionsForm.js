Ext.define('crm.view.ObjectAdditionsForm', {
    extend      : 'Ext.form.Panel',
    id          : "ObjectAdditionsForm",
    alias       : 'widget.ObjectAdditionsForm',
    url         : 'Super.php',
    disabled    : true,
    collapsible : true,
    frame       : true,
            ...
            buttons : [
                {
                    ...
                    handler: function() {
                        SubmitAdditionalForm('ObjectAdditionsForm', 'ObjectTabs', 'ObjectWindow', false);
                    }
                },
                {
                    ...
                    handler: function() {
                        ...
                        SubmitAdditionalForm('ObjectAdditionsForm', 'ObjectTabs', 'ObjectWindow', NeedToClose);
                    }
                },
                {
