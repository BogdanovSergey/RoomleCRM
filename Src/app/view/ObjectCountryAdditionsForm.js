Ext.define('crm.view.ObjectCountryAdditionsForm', {
    extend      : 'Ext.form.Panel',
    id          : "ObjectCountryAdditionsForm",
    alias       : 'widget.ObjectCountryAdditionsForm',
    url         : 'Super.php',
    disabled    : true,
    collapsible : true,
    frame       : true,
            ...
            buttons : [
                {
                    ...
                    handler: function() {
                        SubmitAdditionalForm('ObjectCountryAdditionsForm', 'ObjectCountryTabs', 'ObjectCountryWindow', false);
                    }
                },
                {
                    ...
                    handler: function() {
                        ...
                        SubmitAdditionalForm('ObjectCountryAdditionsForm', 'ObjectCountryTabs', 'ObjectCountryWindow', NeedToClose);
                    }
                },
                {
